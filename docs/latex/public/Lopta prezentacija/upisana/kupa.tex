...
\begin{tikzpicture}
  ...
  \fill[ball color=cyan!10, opacity=1.0]  (O) circle (0.92); % 3D lighting effect
 ...
 %\draw[fill = gray!30, densely dashed, opacity=0.5] (0,-2) to (1.33,1.33);
  ...
  \draw[fill = gray!30, densely dashed, opacity=0.9] (-1.36,1.46) arc [start angle = 170, end angle = 10, x radius = 13.8mm, y radius = 3.6mm];
  \draw[fill = gray!30, opacity=0.9] (-1.29,1.52) arc [start angle=-200, end angle = 20, x radius = 13.75mm, y radius = 3.15mm];
